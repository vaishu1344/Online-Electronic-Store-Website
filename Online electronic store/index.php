...
<html lang="en">
	<head>
	    ...
	    <title>Trimurti Electronics </title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over Rs.10000.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Laptop</a></li>
...
<?php
$ret=mysqli_query($con,"select * from products where category=10 and subCategory=18");
while ($row=mysqli_fetch_array($ret)) 
{
?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Laptops</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=13 and subCategory=20");
while ($row=mysqli_fetch_array($ret)) 
{
?>
